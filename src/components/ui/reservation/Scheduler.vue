          ...
          <div v-for="(item, index) in this.selected.imageData" :key="index" class="file-box">
            ...
            <div class="file_right">
              ...
              <div v-if="item.complete !== '완료'" class="file_btn">
                <button type="button" @click="editReservation(item.id, index)"><img src="../../../assets/images/icon/adjust_i.png" alt="수정" title="수정"></button>
                <button type="button" @click="deleteReservation(item.id, index)"><img src="../../../assets/images/icon/delete_i.png" alt="삭제" title="삭제"></button>
              </div>
            </div>
          </div>
        </div>
