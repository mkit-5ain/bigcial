  ...
  .post_inner_view{width:100%; height:100%; position:relative;
    .post_inner_contents{position:absolute; top:50%; left:50%; transform:translate(-50% ,-50%);
      ...
      .post_like{padding:8px 0px;
        span{padding-left:36px; background:url(../../assets/images/icon/popularity_hover_01.png) left 0 no-repeat; font-size:20px;}
      }
      ...
      .post_save{padding:8px 0px; font-size:20px; cursor:pointer;
        span{padding-left:36px; background:url(../../assets/images/icon/popularity_hover_01.png) left center no-repeat; font-size:20px;}
      }
    }
  }
