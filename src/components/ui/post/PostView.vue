  ...
  <div class="post_contents_wrap">
    <div class="post_contents">
      ...
      <div class="post_info">
        ...
        <div class="right_info">댓글을 클릭하여 블랙리스트를 추가할 수 있습니다.</div>
      </div>
    </div>
  </div>
</template>
...
<style lang="scss" scoped>
  ...
  .contents_right_wrap{float:left;
    .content_wrap {width:470px; height:390px; float:left; overflow-y:scroll; margin-left:35px; padding-right:35px;
      pre{white-space: pre-wrap; font-family: "NanumBarunGothic"; line-height:2;}
    }
    .reply_wrap{float:left; position:relative;
      .post_content_inner_reply{width:470px; height:390px;  overflow-y:scroll; margin-left:35px; padding-right:35px;
